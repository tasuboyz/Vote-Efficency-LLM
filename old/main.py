...
def main():
    ...
    clf_model.save_model('classifier_model.json')
    reg_model.save_model('regressor_model.json')
    logger.info("Modelli salvati con successo come 'classifier_model.json' e 'regressor_model.json'")
